 ...
 */
    public String executePayment(String paymentId, String payerId, Optional<User> user) throws PayPalRESTException {
        APIContext apiContext = getApiContext();
        ...
        if (executedPayment.getState().equals("approved")) {
            accountService.addBalance(user.get().getAccount(), amount, CurrencyCode.RUB);
